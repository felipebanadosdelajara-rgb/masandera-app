...
const STORAGE_KEY = 'masandera_v5';
...
function loadStorage() {
  try {
    ...
    // Restaurar ajustes del plan de producción
    if (snap.prodAjustes && typeof snap.prodAjustes === 'object') {
      STATE.prodAjustes = snap.prodAjustes;
    }
