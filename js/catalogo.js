    ...
    <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap">
      ...
      <div style="display:flex;align-items:center;gap:6px">
        ...
        <select class="form-select" style="width:auto;padding:6px 12px;font-size:12px" onchange="STATE.productCatFilter=this.value;render()">
          ...
          <option value="brioche" ${productCatFilter==='brioche'?'selected':''}>Brioche</option>
        </select>
      </div>
    </div>
      ...
      <tbody>
        ${filtered.map(p => {
          ...
          return `<tr style="${inactivo?'opacity:0.55':''}">
            ...
            <td><span class="cat-badge cat-${p.categoria}">${p.categoria==='brioche'?'Brioche':'Masa Madre'}</span></td>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
      ...
      <div class="form-group">
        ...
        <select class="form-select" id="prodCategoria">
          ...
          <option value="brioche" ${prod?.categoria==='brioche'?'selected':''}>Brioche</option>
        </select>
      </div>
      <div class="form-group">
    ...
    <div class="dispatch-group" style="margin-bottom:20px">
      ...
      ${prods.map(prod => {
        ...
        return `<div class="product-plan-row ${inactivo?'cat-prod-inactive':''}">
          ...
          <span><span class="cat-badge cat-${prod.categoria}">${prod.categoria==='brioche'?'Brioche':'Masa Madre'}</span></span>
          <span>
...
function generarSKU(categoria, tipo) {
  const catCode  = categoria === 'brioche' ? 'BR' : 'MM';
